...
subprocess.call("nvcc parallel_optimized.cu -o parallel_optimized",shell = True)
subprocess.call("./parallel_optimized original_image.px output_image.px compress_output_image.px",shell = True)
