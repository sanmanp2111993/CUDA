...
Bs[ty][tx] = B[Col + (m*TILE_WIDTH + ty)*WIDTH];
 ...
 C[Row*WIDTH+Col] = Pvalue;
   ...
   runtime[tx] = (unsigned long long)(stop_time - start_time); 
}
...
{   
    ...
    // --> 
    dim3 blocksPerGrid(4,4,1);// FILL HERE
    dim3 threadsPerBlock(8,8,1);// FILL HERE
	printf("CUDA kernel launch with 4 blocks of 8 threads\n");
